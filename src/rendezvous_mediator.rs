...
/// `CONNECT_TIMEOUT`, and at the limit an arrival is declined rather than an older punch cut
/// short. Declined is the listen alone, never the reply: that carries the WebRTC answer and the
/// v6 address as well, and those go on without a v4 punch.
///
